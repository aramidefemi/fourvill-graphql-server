...
const workspaces_schema = fs.readFileSync('./graphql/workspaces/schema.graphql',{encoding:'utf-8'})
...
var resolvers = {}; 
const schema = makeExecutableSchema({typeDefs, resolvers: merge(resolvers,users_resolvers,workspaces_resolvers)});
